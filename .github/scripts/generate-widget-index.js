...
function extractWidgetMetadata(filePath) {
  try {
    ...
    const url = `https://raw.githubusercontent.com/QiXiuYuano/ForwardWidgets/refs/heads/main/widgets/${fileName}`
...
async function main() {
  try {
    ...
    const metadata = {
      title: "QiXiuYuano's Widgets",
      description: 'Forward Widgets by QiXiuYuano',
      icon: 'https://raw.githubusercontent.com/QiXiuYuano/Profiles/main/icon/forward-widget.png',
      widgets: widgetIndex
    }
